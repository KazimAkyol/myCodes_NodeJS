...
//* Spread Operator
const newObj = { newKey: "newValues", ...Car };
// console.log(newObj);
...
console.log(jsonCar);
console.log(jsonCar.brand); // string icinde nokta notasyonu kullanilamaz.

//* JSON to Object
const obj = JSON.parse(jsonCar);
console.log(typeof obj);
console.log(obj.brand); // obje icinde nokta notasyonuyla hedeflenen attribute'e ulasilir.
